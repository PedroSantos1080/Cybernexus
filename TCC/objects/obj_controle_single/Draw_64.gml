...
if (room == rm_derrota_singleplayer) {
	draw_set_halign(fa_center);
	draw_set_valign(fa_middle);
	draw_set_font(f_dano);
	draw_text_ext_color(_largura/2, _altura/2, "Nucleo destruido, voce perdeu :(", 80, 900, _c, _c, _c, _c, 1);
	draw_text_ext_color(_largura/2, _altura/2 + 40, "Pressione Enter para voltar ao menu principal", 80, 900, _c, _c, _c, _c, 1);	
