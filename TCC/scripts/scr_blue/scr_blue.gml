...
function scr_blue_perdendo() {
	...
	if (direc == 0) {
		sprite_index = spr_blue_perdendo_direita;
	}else if (direc == 1) {
		sprite_index = spr_blue_perdendo_esquerda;
	}else if (direc == 3) {
		sprite_index = spr_blue_perdendo_frente;
	}else {
		sprite_index = spr_blue_perdendo_costas;
	}
